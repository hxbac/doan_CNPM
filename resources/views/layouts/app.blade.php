    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-4 text-justify">Tại đây, bạn sẽ tìm thấy máy tính và các sản phẩm công nghệ liên quan chất lượng, đa dạng và đáng tin cậy. Hãy khám phá ngay!</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>178 Lê Duẩn, thành phố Vinh, Nghệ An</p>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        <h5 class="text-secondary text-uppercase mb-4">Multi shop</h5>
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Bài viết</a>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Trả Hàng & Hoàn Tiền</a>
