                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center"
                                ...
                                <div class="caption ml-3">
                                    <h6 class="mb-0 line-height">{{ Auth::user() ? Auth::user()->name : '' }}<i
                            ...
                            <ul class="dropdown-menu dropdown-menu-right border-none"
                                ...
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="{{ asset('') }}admin/app/user-profile.html">My Profile</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="{{ asset('') }}admin/app/user-profile-edit.html">Edit Profile</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="{{ asset('') }}admin/app/user-account-setting.html">Account Settings</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="{{ asset('') }}admin/app/user-privacy-setting.html">Privacy Settings</a>
                                </li>
                                <li class="dropdown-item  d-flex svg-icon border-top">
                                    ...
                                    <a href="{{ asset('') }}admin/backend/auth-sign-in.html">Logout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
